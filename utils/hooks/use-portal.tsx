// usePortal API
// Taken from https://www.jayfreestone.com/writing/react-portals-with-hooks/
...
function usePortal(id: string) {
  ...
  useEffect(() => {
    ...
    const rootElemExists = rootElemRef.current;
    // Parent is either a new root or the existing dom element
    let parentElem = createRootElement(id);
    ...
    return function removeElement() {
      rootElemExists && rootElemRef.current.remove();
